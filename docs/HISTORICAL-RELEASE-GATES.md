# Historical gate sheet

Superseded as the current release-status page by RELEASE-GATES.md. Preserved without rewriting the original broad campaign requirements.
